    ...
    return (
        <div className="expenses-page">
            <div className="page-header">
                ...
                <button className="expenses-btn-success" onClick={() => { resetForm(); setSelectedIncome(null); setIsCreateOpen(true); }}>
                ...
                <div className="modal-overlay">
                    <div className="modal-content large-modal">
                        ...
                        <div className="modal-footer">
                            ...
                            <button className="btn-save" onClick={() => { setIsViewOpen(false); handleEdit(selectedIncome); }}>Edit</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="modal-overlay">
                    <div className="modal-content large-modal">
                        ...
                        <div className="modal-footer">
                            ...
                            <button className="btn-save" onClick={handleSave}>{selectedIncome ? 'Update' : 'Save'}</button>
                        </div>
                    </div>
                </div>
            )}
